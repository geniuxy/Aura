...
void UMVVM_LoadScreen::NewSlotButtonPressed(int32 Slot, const FString& EnteredName)
{
	...
	{
		Debug::Print(FString("Please switch to Single Player"));
		return;
	}
...
void UMVVM_LoadScreen::PlayButtonPressed()
{
	...
	AuraGameInstance->CurMapName = SelectedSlot->GetMapName();
...
void UMVVM_LoadScreen::LoadData()
{
	...
	for (const TTuple<int32, UMVVM_LoadSlot*> LoadSlot : LoadSlots)
	{
		ULoadScreenSaveGame* SaveObject =
			AuraGameMode->GetSaveSlotData(LoadSlot.Value->GetLoadSlotName(), LoadSlot.Key);
